<div class="modal fade" id="edit-modal-{{ $bank->id }}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        ...
        <div class="modal-body">
          <div class="form-row">
            ...
            <div class="col-md-6">
              ...
              <input type="text" class="form-control" name="kode_bank" value="{{ $bank->kode_bank }}" required onkeypress="isNumber(event)">
            </div>
